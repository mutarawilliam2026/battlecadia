...
- **Product data / AI search:** not chosen yet. The product-search step (the candidate
  items that battle) still needs a data source and an NL-parsing layer to be selected.
